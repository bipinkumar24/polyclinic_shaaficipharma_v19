...
class stock_picking(models.Model):
    ...
    def action_cancel(self):
        ...
        account_move_ids = (self.move_ids + scraps.move_ids).account_move_id
    ...
    def set_quant_quantity(self, stock_move, pack_operation_ids, pic_state):
        for pack_operation_id in pack_operation_ids:
            ...
            if stock_move.quantity:
                ...
                if stock_move.product_id.is_storable:
    ...
    def _action_cancel(self):
        for move in self:
            if move.account_move_id:
                move.account_move_id.sudo().button_draft()
                move.account_move_id.sudo().unlink()
