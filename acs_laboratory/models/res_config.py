...
class ResCompany(models.Model):
    ...
    acs_labresult_qrcode = fields.Boolean(string="Print Authentication QrCode on Laboratory Result", default=True)
    ...
    acs_no_lab_result = fields.Boolean(string="No Lab Result", default=False)
...
class ResConfigSettings(models.TransientModel):
    ...
    acs_labresult_qrcode = fields.Boolean(related='company_id.acs_labresult_qrcode', string="Print Authentication QrCode on Laboratory Result", readonly=False)
    ...
    acs_no_lab_result = fields.Boolean(related='company_id.acs_no_lab_result', string="No Lab Result", readonly=False)
