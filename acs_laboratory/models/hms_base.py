...
class AccountInvoice(models.Model):
    ...
    def acs_update_record_state(self):
        ...
        records = self.env['acs.laboratory.request'].search([('invoice_id', 'in', self.ids),('state','=','to_invoice')])
        if records:
            records.button_done()
...
class IrAttachment(models.Model):
    ...
    acs_show_in_portal = fields.Boolean(string='Show in Portal', default=True)
