...
class DocumentDirectory(models.Model):
    ...
    def _get_attachment_count(self):
        ...
        for rec in self.sudo():
            ...
            rec.attachment_count = AttachmentObj.search_count(domain)
    ...
    attachment_count = fields.Integer(compute='_get_attachment_count', string="Number of documents attached")
