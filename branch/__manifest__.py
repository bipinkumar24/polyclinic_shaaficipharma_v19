...
operating-Unit Operation for POS,operating-Unit Operation for Sales,operating-Unit operation for Purchase,operating-Unit operation for all, operating-Unit operation for Accounting,operating-Unit Operation for invoicing,operating-Unit operation for Payment order,operating-Unit operation for point of sales,operating-Unit operation for voucher,operating-Unit operation for All Accounting reports,operating-Unit operation Accounting filter.
    """,
    'author': 'BROWSEINFO',
    'website': 'https://www.browseinfo.com/demo-request?app=branch&version=18&edition=Community',
    "price": 149.00,
    "currency": 'EUR',
    'depends': ['base', 'sale_management', 'purchase', 'sale_stock', 'account', 'purchase_stock','web'],
    ...
    'assets': {
        'web.assets_backend': [
            # 'branch/static/src/**/*',
            'branch/static/src/js/switch_branch_item.js',
            'branch/static/src/js/mobile_switch_branch_menu.js',
            'branch/static/src/js/burger_menu.js',
            'branch/static/src/js/branch_service.js',
            'branch/static/src/js/session.js',
            'branch/static/src/xml/branch.xml',
            'branch/static/src/xml/switch_branch_item.xml',
            'branch/static/src/xml/burger_menu_ext.xml',
            'branch/static/src/xml/mobile_switch_branch_menu.xml',
        ]
    },
    'license' : 'OPL-1',
    'demo': [],
    ...
    'installable': True,
    'auto_install': False,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=branch&version=18&edition=Community',
