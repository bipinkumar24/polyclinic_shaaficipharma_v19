...
class AcsPatientProcedure(models.Model):
    ...
    def get_procedure_invoice_data(self):
        ...
        for rec in self:
            ...
            for consumable in rec.consumable_line_ids.filtered(lambda x: not x.move_line_id):
                ...
                product_data.append({
                    ...
                    'line_type': 'procedure',
                    'consumable_line_id': consumable.id,
                })
        return product_data
...
class AccountMoveLine(models.Model):
    ...
    consumable_line_id = fields.Many2one('hms.consumable.line', string="Consumable Request Line")
    ...
    def create(self, vals_list):
        ...
        for line in records:
            if line.consumable_line_id:
                line.consumable_line_id.move_line_id = line.id
