...
class AcsPatientProcedure(models.Model):
    ...
    def default_get(self, default_fields):
        res = super(AcsPatientProcedure, self).default_get(default_fields)
...
class AccountMove(models.Model):
    ...
    def action_post(self):
        ...
        for move in self:
            procedure_request_move_ids = move.procedure_request_move_ids
            if procedure_request_move_ids:
                procedure_request_move_ids.button_accept()
        return res
